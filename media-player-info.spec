...
Version  : 26
Release  : 5
URL      : https://gitlab.freedesktop.org/-/project/892/uploads/6405aa521d34a8eeadea7406c304d37e/media-player-info-26.tar.gz
Source0  : https://gitlab.freedesktop.org/-/project/892/uploads/6405aa521d34a8eeadea7406c304d37e/media-player-info-26.tar.gz
...
%prep
%setup -q -n media-player-info-26
cd %{_builddir}/media-player-info-26
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743198448
...
cp %{_builddir}/media-player-info-%{version}/COPYING %{buildroot}/usr/share/package-licenses/media-player-info/0076bf26a7e2136bc181efa09578d5108e1ac15d || :
cp %{_builddir}/media-player-info-%{version}/tools/COPYING %{buildroot}/usr/share/package-licenses/media-player-info/b47456e2c1f38c40346ff00db976a2badf36b5e3 || :
export GOAMD64=v2
GOAMD64=v2
%make_install
...
/usr/share/metainfo/org.freedesktop.media_player_info.metainfo.xml
